...
const Footer = () => {
    return (
        <>
            ...
            <footer className="bg-black text-white pt-12 pb-6 border-t border-white/5" id="contact">
                    ...
                    <div className="grid md:grid-cols-4 gap-16 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-4 font-light text-gray-300">
                                ...
                                <li><a className="hover:text-white transition-colors" href="#">Contracting</a></li>
                                <li><a className="hover:text-white transition-colors" href="#">Project Management Team</a></li>
                        ...
                        <div>
                            ...
                            <address className="not-italic text-gray-300 font-light leading-loose">
                                ...
                                <a className="text-white border-b border-[#FFB800] pb-1" href="mailto:info@countrylabinteriors.com">info@countrylabinteriors.com</a>
                            </address>
                        </div>
                    </div>
                    <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-white/10 text-gray-500 text-xs tracking-widest uppercase">
